...
@Configurable
@TeleOp
public class TeleOpSortare extends LinearOpMode {
    ...
    int greencount = 0;
    double Time = 0;
    public int towerX = BNG_BLUE_TOWER_X;
    public int towerY = BNG_BLUE_TOWER_Y;
    ...
    private final Pose START_POSE = BNG_BLUE_START_POSE;
...
//NEW
    ...
    public  double servo1= 0.7;
    public  double servo2= 0.5;
    public  double servoFAR2= 0.3;
    public  double servo3= 0.25;
    public  double servo32= 0.35;

    public  double servo4= 0.0;

    public double targetVel1 = 1250;
    public double targetVel2 = 1100;
    public double targetVel3 = 900;
    ...
    public double timerClose = 300;
    public double timerFar1 = 800;
    public double timerFar2 = 1200;
    boolean FAR = false;
    boolean CLOSE = false;
    ...
    //sortare
    String presetCase = "";
    String[] pickAssignment = new String[4];   // 1,2,3
    int ballIndex = 0;
    boolean presetActive = false;
    int stateCollectSelectiv = 0;
    ElapsedTime presetTimer = new ElapsedTime();
...
// Activare preset
            ...
            if (gamepad1.circle){
                follower.setPose(new Pose(18,  119 , Math.toRadians(145)));
            }
...
//
//                case 1:
//                    if (distance <= 60 && collecttimer.milliseconds() > COLLECT_DELAY_POSE1_TO_2_MS) {
//                        indexer.PickPose1();
//                        collecttimer.reset();
//                        stateCollect = 2;
//                    }
...
//
//                case 2:
//                    if (distance <= 60 && collecttimer.milliseconds() > COLLECT_DELAY_POSE2_TO_3_MS) {
//                        collecttimer.reset();
//                        allBallsIn = true;
//                        stopIntake = true;
...
//Reset Collect
            ...
            telemetry.addData("sattecollect", stateCollectSelectiv);
