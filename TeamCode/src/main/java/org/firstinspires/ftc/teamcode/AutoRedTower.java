...
@Autonomous(name = "AutoRedTower")
public class AutoRedTower extends OpMode {
    ...
    private final Pose startPose = new Pose(-35.35, 182, Math.toRadians(225));
    private final Pose detectPose = new Pose(5, 145, Math.toRadians(180));
    private final Pose scorePose = new Pose(5.5, 144.5  , Math.toRadians(135));
    private final Pose pickup1PoseAngle = new Pose(6.5, 155, Math.toRadians(90));
    private final Pose pickup1Pose= new Pose(6.5, 180, Math.toRadians(90));
    private final Pose pickup2PoseAngle = new Pose(28, 155, Math.toRadians(90));
    private final Pose pickup2Pose= new Pose(28, 190, Math.toRadians(90));
    private final Pose pickup3PoseAngle = new Pose(50, 155, Math.toRadians(90));
    private final Pose pickup3Pose = new Pose(50, 185, Math.toRadians(90));
