...
//143
    ...
    private final Pose START_POSE = new Pose(40, 12, Math.toRadians(180)); // Exemplu: poziție start + heading 90° (spre nord)
...
//Collect
            switch (stateCollect) {
                ...
                case 1:
                    if (distance <= 69 && collecttimer.milliseconds() > 600) {
                        indexer.PickPose3();
                        collecttimer.reset();
                        stateCollect = 2;
                    }
                ...
                case 2: // PickPose3
                    if (distance <= 69 && collecttimer.milliseconds() > 300) {
                        collecttimer.reset();
                        indexer.OuttakePose1();
                        targetRPM =getTargetRPM;
                        allBallsIn = true;
