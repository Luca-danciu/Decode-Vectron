...
//                }
            ...
            case 7:
                if (!follower.isBusy()){
                    follower.followPath(grabPickup2 , AUTO_PATH_SPEED_FAST , true);
                    setPathState(8);
                }
                break;
            case 8:
...
//                }
            ...
            case 11:
                if (!follower.isBusy()){
                    follower.followPath(grabPickup3 , AUTO_PATH_SPEED_FAST , true);
                    setPathState(12);
                }
                break;
            case 12:
...
//                    pathTimer.resetTimer();
                    ...
                    targetRPM = AUTO_LAUNCHER_RPM_CLOSE_SHOT;
                    targetPosition = -170;
                    setPathState(13);
                }
                break;
